...
public interface IModelStorage
{
    ...
    Task<bool> UpdateDetailsAsync(Guid id, Dictionary<string, string> metadata, CancellationToken ct = default);
    
    Task<bool> UpdateNewAsync(Guid id, CancellationToken ct = default);
